// ABOUTME: Main library for PingZilla Next - a menu bar ping monitor
...
fn build_tray_menu(
    ...
    menu_items.push(Box::new(PredefinedMenuItem::separator(app)?));
    let quit = MenuItem::with_id(app, "quit", "Quit PingZilla Next", true, None::<&str>)?;
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            let _tray = TrayIconBuilder::with_id("main-tray")
                ...
                .title("...")
                .tooltip("PingZilla Next - Network Monitor")
                .menu(&initial_menu)
